...
public class airportRunway {
    ...
    static void printFlight(int slot, flight f) {
        ...
        System.out.println("  Emergency: " + (f.emergency ? "Yes" : "No"));
    ...
    public static void main(String[] args) {
        ...
        // flightCode, fuelLevel, emergency, longHaul, queuedAt, landedAt
        ...
        while (!runway.isEmpty()) {
            flight nextFlight = runway.landNext();
            printFlight(slot, nextFlight);
            slot++;
        }
